...
$("#switch").click(function(){
	if ($("#roleBox").css('display') == "none") {
		$(this).text("收起导航");
		$('#roleBox').fadeIn('slow');
		$("#recommendSite").fadeIn('slow');
		return;
	};
	if ($("#roleBox").css('display') == "block") {
		$(this).text("展开导航");
		$('#roleBox').fadeOut(500,function(){
			$("#roleBox").css("display","none");
		})
		$("#recommendSite").fadeOut(500,function(){
...
$("li[name='easylife']").click(function(){
	showRecommend(easylife);
});
$("li[name='undergraduate']").click(function(){
	showRecommend(undergraduate);
});
$("li[name='video']").click(function(){
	showRecommend(video);
});
